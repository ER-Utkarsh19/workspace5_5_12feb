...
static void rotate_180_rgb565_inplace(uint16_t *buf, int width, int height)
{
...
static bool s_camera_get_finished_trans(esp_cam_ctlr_handle_t handle, esp_cam_ctlr_trans_t *trans, void *user_data)
{
    ...
    // rotate the buffer 180 degrees in-place (RGB565)
    rotate_180_rgb565_inplace((uint16_t *)trans->buffer, CONFIG_EXAMPLE_CAM_HRES, CONFIG_EXAMPLE_CAM_VRES);
