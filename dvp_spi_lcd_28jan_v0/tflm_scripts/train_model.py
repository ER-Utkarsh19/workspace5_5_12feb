...
def train():
    ...
    if not os.path.exists(DATASET_DIR):
        print(f"ERROR: '{DATASET_DIR}' folder not found. Run extract_images.py first!")
        return
    ...
    def representative_data_gen():
        for input_value, _ in train_ds.take(100):
            # Ensure input is float32 for conversion
...
"""
    ...
    print("\nSUCCESS! 'model_data.cc' has been generated.")
    print("Copy this file to your ESP32 /main folder now.")
